...
export default function App() {
  ...
  /*Her styler jeg jeg min tab-nav-bar når brugeren er logget ind*/
  function BottomStackScreen(){
    return (
      ...
      /*Her laver jeg hvert felt nede i tab-nav-baren, og styler dens størrelse og position. Kunne godt tænke mig det anderledes hen af vejen */
      >
        <Tab.Screen name="Dashboard" component={Home} options={{
          tabBarIcon: ({ color }) => <AntDesign name="home" size={30} color={color} style={{marginLeft: 10, marginBottom: 25, marginTop: -20, }} />
        }} />
        <Tab.Screen name="Profil" component={Home} options={{
          tabBarIcon: ({ color }) => <MaterialIcons name="settings" size={30} color={color} style={{ marginLeft: 10, marginBottom: 25, marginTop: -20, }} />
        }} />
        ...
        <Tab.Screen name="Hent Mad" component={Home} options={{
          tabBarIcon: ({ color }) => <MaterialIcons name="food-bank" size={30} color={color} style={{ marginLeft: 10, marginBottom: 25, marginTop: -20, }} />
        }} />
      </Tab.Navigator>
  ...
  /*En const som bliver kaldt over på routen Splash*/
  const screenOptions = {
    headershown: false,
    ...TransitionPresets.SlideFromRightIOS,
  }
/* Her definerer jeg alle de views som appen indeholder*/
  return (
    <NavigationContainer>
          ...
          <Stack.Screen name="Login" component={Login} options={{
           ...
           <Stack.Screen name="Register" component={Register} options={{
            ...
            headerShown: false,
                    ...
                    /* Jeg mangler at få de sidste 3 componenter i spil.*/
             }}/> 
